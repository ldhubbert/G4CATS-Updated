#include <TMath.h>
{
  ...
  h1->Draw();
  h1->SetTitle("8% Gaussian Smear on 300MeV Beam");

  line->Draw();

  //Compare to normal 300MeV Histogram (taken from code in Histogram folder)
  c1->cd(1);
  TH1F *h2 = new TH1F("Histogram 1", "", 200, 200, 350);
...
/*
  cout << "Contents of Bin 314:" << endl;
  cout << h1->GetBinContent(314) << endl;
  cout << "Contents of Bin 315:" << endl;
  cout << h1->GetBinContent(315) << endl;
  cout << "Contents of Bin 357:" << endl;
  cout << h1->GetBinContent(357) << endl;
  cout << "Contents of Bin 358:" << endl;
  cout << h1->GetBinContent(358) << endl;
*/
  //Getting bin center that roughly corresponds to HalfMaxYValue on lower threshold
  Double_t LowerWholeBinFraction = h1->GetBinContent(314)/h1->GetBinContent(315);
  cout << "Lower Bin Fraction:" << endl;
  cout << LowerWholeBinFraction << endl;
  cout << "x-value corresponding to the center of bin 314:" << endl;
  Double_t Center314 = h1->GetBinCenter(314);
  cout << Center314 << endl;
  Double_t Center315 = h1->GetBinCenter(315);
  cout << "x-value corresponding to the center of bin 315:" << endl;
  cout << Center315 << endl;
  Double_t LowerBinWidth = Center315 - Center314;
  cout << "Lower Bin Width:" << endl;
  cout << LowerBinWidth << endl;

  Double_t LowerXValue = Center314 + (LowerBinWidth)*(LowerWholeBinFraction);
  cout << "/////////////////////////////////////" << endl;
  cout << LowerXValue << endl;
  cout << "/////////////////////////////////////" << endl;

  //Getting bin center that roughly corresponds to HalfMaxYValue on upper threshold
  Double_t UpperWholeBinFraction = h1->GetBinContent(358)/h1->GetBinContent(357);
  cout << "Upper Bin Fraction:" << endl;
  cout << UpperWholeBinFraction << endl;
  cout << "x-value corresponding to the center of bin 357:" << endl;
  Double_t Center357 = h1->GetBinCenter(357);
  cout << Center357 << endl;
  Double_t Center358 = h1->GetBinCenter(358);
  cout << "x-value corresponding to the center of bin 358:" << endl;
  cout << Center358 << endl;
  Double_t UpperBinWidth = Center358 - Center357;
  cout << "Upper Bin Width:" << endl;
  cout << UpperBinWidth << endl;

  Double_t UpperXValue = Center358 + (UpperBinWidth)*(UpperWholeBinFraction);
  cout << "//////////////////////////////////////" << endl;
