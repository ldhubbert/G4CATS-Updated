#include <TMath.h>
{
  ...
  c1->cd(1);
  TH1F *h2 = new TH1F("Histogram 1", "", 200, 75, 105);
  ...
  for (Int_t i = 0; i < 200; i++)
	...
	//Lower Bound
	else if ((x > (HalfMaxYValue-100)) && (x < HalfMaxYValue))
		{
  ...
  //cout << "Contents of Bin 154:" << endl;
  //cout << h1->GetBinContent(154) << endl;
  //cout << "Contents of Bin 177:" << endl;
  //cout << h1->GetBinContent(177) << endl;

  //Getting bin center that roughly corresponds to HalfMaxYValue on lower threshold
  Double_t LowerWholeBinFraction = h1->GetBinContent(154)/h1->GetBinContent(155);
  cout << "Lower Bin Fraction:" << endl;
  cout << LowerWholeBinFraction << endl;
  cout << "x-value corresponding to the center of bin 154:" << endl;
  Double_t Center154 = h1->GetBinCenter(154);
  cout << Center154 << endl;
  Double_t Center155 = h1->GetBinCenter(155);
  cout << "x-value corresponding to the center of bin 155:" << endl;
  cout << Center155 << endl;
  Double_t LowerBinWidth = Center155 - Center154;
  cout << "Lower Bin Width:" << endl;
  cout << LowerBinWidth << endl;

  Double_t LowerXValue = Center154 + (LowerBinWidth)*(LowerWholeBinFraction);
  cout << "/////////////////////////////////////" << endl;
  cout << LowerXValue << endl;
  cout << "/////////////////////////////////////" << endl;

  //Getting bin center that roughly corresponds to HalfMaxYValue on upper threshold
  Double_t UpperWholeBinFraction = h1->GetBinContent(178)/h1->GetBinContent(177);
  cout << "Upper Bin Fraction:" << endl;
  cout << UpperWholeBinFraction << endl;
  cout << "x-value corresponding to the center of bin 177:" << endl;
  Double_t Center177 = h1->GetBinCenter(177);
  cout << Center177 << endl;
  Double_t Center178 = h1->GetBinCenter(178);
  cout << "x-value corresponding to the center of bin 178:" << endl;
  cout << Center178 << endl;
  Double_t UpperBinWidth = Center178 - Center177;
  cout << "Upper Bin Width:" << endl;
  cout << UpperBinWidth << endl;

  Double_t UpperXValue = Center178 + (UpperBinWidth)*(UpperWholeBinFraction);
  cout << "//////////////////////////////////////" << endl;
