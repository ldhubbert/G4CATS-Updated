...
void H100MeVsmearM.C()
{
	...
	TString filename = "~/Vincent/G4CATS/Out/B4_100MeV.root";
	...
	//Create histogram
	TH1F *h1 = new TH1F("Histogram 1 Statistics", "", 200, 85, 105);
	...
	TH1F *h2 = new TH1F("Histogram 2 Statistics", "", 200, 85, 105);
	while (r2.Next())
	{
