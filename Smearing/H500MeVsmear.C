...
void H500MeVsmear()
{
	...
	f1->SetParameter(0, (1/((0.15*TMath::Sqrt(500))*(TMath::Sqrt(2*TMath::Pi())))));
	//f1->SetParameter(0, 1);
	//Mean
	f1->SetParameter(1, 0);
	//Standard Deviation
	f1->SetParameter(2, (0.15*TMath::Sqrt(500)));
	...
	//Create histogram
	TH1F *h1 = new TH1F("Histogram 1 Statistics", "", 600, 455, 515);
	...
	h1->SetTitle("15% Gaussian Smear on 500MeV Beam");
	h1->Draw();

	TLine *line = new TLine(500, 0, 500, 900);
	line->Draw();
	...
	TH1F *h2 = new TH1F("Histogram 2 Statistics", "", 600, 455, 515);
	while (r2.Next())
	{
	...
	TPaveLabel *a = new TPaveLabel(458,700,470,850, FWHM_string);
	a->Draw();
}
